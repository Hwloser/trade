# btc-research-workspace Specification

## Purpose
Define the capability-gated BTC research workspace, point-in-time evidence
hierarchy, chart interaction, failure states, and non-recommendation boundaries.
## Requirements
