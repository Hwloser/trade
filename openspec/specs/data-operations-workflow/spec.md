# data-operations-workflow Specification

## Purpose
Define the concise, profile-driven data operations surface with explicit
read-only status, bounded updates, strict checks, and compatibility routing.
## Requirements
