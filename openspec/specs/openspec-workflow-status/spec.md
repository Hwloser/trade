# openspec-workflow-status Specification

## Purpose
Define read-only aggregation of OpenSpec authoring, validation, governance,
implementation progress, archive readiness, and deterministic next actions.
## Requirements
