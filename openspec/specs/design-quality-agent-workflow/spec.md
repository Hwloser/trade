# design-quality-agent-workflow Specification

## Purpose
Define the governed pre-code agent workflow for applicability, design evidence,
consensus review, strict approval, and implementation handoff.
## Requirements
