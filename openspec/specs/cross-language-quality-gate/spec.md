# cross-language-quality-gate Specification

## Purpose
Define the deterministic, changed-scope developer quality gate for all supported
repository languages while preserving explicit fix behavior and protected state.
## Requirements
