# code-quality-agent-workflow Specification

## Purpose
Define the repository-local agent workflow that keeps code changes scoped,
language-aware, data-safe, and supported by reproducible validation evidence.
## Requirements
