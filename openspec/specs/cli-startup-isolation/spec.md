# cli-startup-isolation Specification

## Purpose
Define lazy CLI dispatch and read-only help behavior so unselected runtime
domains and optional dependencies cannot break unrelated commands.
## Requirements
